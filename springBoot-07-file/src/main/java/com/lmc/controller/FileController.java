...
//                for(User mapper: users){
//                    //换行
//                    document.add(new Chunk("\n"));
//                    //标题
//                    cell = new PdfPCell(new Paragraph(mapper.getId()+""));
//                    //居中对齐
//                    cell.setHorizontalAlignment(1);
//                    //将单元格加入表格
//                    pt.addCell(cell);
...
//                    document.add(new Chunk("\n"));
//                    //标题
//                    cell = new PdfPCell(new Paragraph(mapper.getUsername()));
//                    //居中对齐
//                    cell.setHorizontalAlignment(1);
//                    //将单元格加入表格
//                    pt.addCell(cell);
...
//                    document.add(new Chunk("\n"));
//                    //标题
//                    cell = new PdfPCell(new Paragraph(mapper.getPassword()));
//                    //居中对齐
//                    cell.setHorizontalAlignment(1);
//                    //将单元格加入表格
//                    pt.addCell(cell);
